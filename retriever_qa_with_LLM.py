...
config=AutoConfig.from_pretrained("/workspace/FastChat/checkpoint-10")
model = AutoModelForCausalLM.from_pretrained(pretrained_model_name_or_path="/workspace/FastChat/checkpoint-10",config=config)
